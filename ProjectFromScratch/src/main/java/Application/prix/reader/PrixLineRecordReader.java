...
@Evolving
public class PrixLineRecordReader extends RecordReader<PrixLongWritable, PrixText> implements Serializable {
    private static final Logger LOG = LoggerFactory.getLogger(org.apache.hadoop.mapreduce.lib.input.LineRecordReader.class);
    ...
    private PrixLongWritable key;
    private PrixText value;
    private boolean isCompressedInput;
    private Decompressor decompressor;
    private byte[] recordDelimiterBytes;

    public PrixLineRecordReader() {
    }

    public PrixLineRecordReader(byte[] recordDelimiter) {
    ...
    public boolean nextKeyValue() throws IOException {
        if (this.key == null) {
            this.key = new PrixLongWritable();
        }

        this.key.set(this.pos);
        if (this.value == null) {
            this.value = new PrixText();
        }
    ...
    public PrixLongWritable getCurrentKey() {
        return this.key;
    }

    public PrixText getCurrentValue() {
        return this.value;
    }
